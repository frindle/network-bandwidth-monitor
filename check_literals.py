...
TARGET = pathlib.Path('app/metrics.py')

# frozen from TASK.md -- re-run `ollama-dispatch-scaffold --freeze-literals .`
LITERALS = [[None, 'render_line_protocol'], [None, 'netmon_interface'], [None, 'netmon_wan'], [None, 'netmon_fw_poll'], [None, 'Blueprint'], [None, '/api/metrics']]
